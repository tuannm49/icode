...
describe('Service Tests', () => {
  describe('Table1 Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(Table1Service);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Table1(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Table1', () => {
        ...
        service.create(new Table1()).subscribe(resp => (expectedResult = resp.body));
