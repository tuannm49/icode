...
describe('Service Tests', () => {
  describe('Table2 Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = null;
      injector = getTestBed();
      service = injector.get(Table2Service);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Table2(0, 'AAAAAAA');
    });
    ...
    describe('Service methods', () => {
      ...
      it('should create a Table2', () => {
        ...
        service.create(new Table2()).subscribe(resp => (expectedResult = resp.body));
