...
@RestController
@RequestMapping("/api/icode-kafka")
public class IcodeKafkaResource {

    private final Logger log = LoggerFactory.getLogger(IcodeKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public IcodeKafkaResource(KafkaProperties kafkaProperties) {
